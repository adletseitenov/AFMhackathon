...
_FEATURE_LABELS = {
    ...
    "pyramid_recruit": "Вербовка в структуру/матрицу (уровни, пожизненные выплаты, реинвест)",
    "promo_code": "Промокод",
    "crypto_iban": "Крипто-кошелёк/реквизиты",
    "urgency": "Срочность/давление",
    "scam_payment_demand": "Требование оплаты/перевода или реквизитов карты (фишинг)",
    "fake_prize_grant": "Фейковый выигрыш/приз/грант как приманка",
    "crypto_scam": "Крипто-схема: удвоение/арбитраж/майнинг/раздача",
